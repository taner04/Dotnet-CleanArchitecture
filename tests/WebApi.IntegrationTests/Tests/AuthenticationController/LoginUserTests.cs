...
public class LoginUserTests(TestingFixture fixture) : TestingBase(fixture)
{
    ...
    public async Task Login_WithInvalidCredentials_ReturnsBadRequest()
    {
        ...
        var invalidEmailResponse = await client.PostAsJsonAsync(Routes.Auth.Login, invalidEmailQuery, CurrentCancellationToken);
        ...
        var invalidPasswordResponse = await client.PostAsJsonAsync(Routes.Auth.Login, invalidPasswordQuery, CurrentCancellationToken);
