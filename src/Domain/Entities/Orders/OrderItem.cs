...
#pragma warning restore CS8618 
        ...
        public static OrderItem TryCreate(OrderItemId id, OrderId orderId,ProductId productId, int quantity, Money unitPrice)
        {
            if (id == Guid.Empty || productId == Guid.Empty || orderId == Guid.Empty)
            {
